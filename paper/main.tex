...
At 10,000 steps ($n$=30), $d$=1.43, $\delta$=0.72 ($p < 0.001$);
normal populations reach $\bar{x}$=358.1 vs.\ 327.1 for no-evolution
($\Delta$=$-$8.7\%).
...
($\bar{x}$=384.6 vs.\ 361.4, $d$=1.01, $\delta$=0.57, $p < 0.001$).
...
Figure~\ref{fig:graded} (left) shows a monotonic dose-response: population
...
($d$=3.23, Cliff's $\delta$=0.99, $p < 0.001$; Figure~\ref{fig:graded},
...
dose-response (Figure~\ref{fig:graded}).
