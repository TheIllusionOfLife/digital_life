...
failure pathways). Baseline $\bar{x}$=293, consistent with
...
internal state variable~$s_0$, maintaining it near $\sim$0.99 throughout
the simulation (Panel~A, solid line).
...
counteract perturbations (Panel~B, dashed line).
...
regulation near 1.0, while No Homeostasis (dashed) shows passive decay.
