...
sys.modules["digital_life"] = MagicMock()
        ...
        "organism_snapshots": [
            {
                "step": 0,
                "organisms": [
                    {"stable_id": 1, "energy": 10.0, "waste": 1.0, "boundary_integrity": 0.9, "maturity": 0.5, "generation": 2},
                    {"stable_id": 2, "energy": 20.0, "waste": 2.0, "boundary_integrity": 0.8, "maturity": 0.6, "generation": 3},
                ]
            }
        ]
    }]
...
if __name__ == "__main__":
    try:
        test_collect_organism_traits()
        test_extract_shared_traits()
